...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Powered by
	$power_by 		= "Archivista GmbH";
	$power_url 		= "http://www.archivista.ch";
	...
	//$help_base_url = $path_to_root.'/modules/wiki/index.php?n='.tr('Help').'.';
	$help_base_url = null;
	...
	*/
 	$applications = array (
 		'orders' => tr("Sales"),
 		'AP'=>tr("Purchases"),
 		'stock'=> tr("Items and Inventory"),
 		'manuf'=> tr("Manufacturing"),
 		'proj'=>tr("Dimensions"),
 		'GL'=>tr("Banking and General Ledger"),
 		'system'=>tr("Setup")
 	);
