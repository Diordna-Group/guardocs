...
page(tr("Allocate Customer Payment or Credit Note"), false, false, "", $js);
...
function edit_allocations_for_transaction($type, $trans_no)
{
    ...
    if (count($_SESSION['alloc']->allocs) > 0)
    {
        ...
        foreach ($_SESSION['alloc']->allocs as $allocn_item)
        {
       	...
       	label_row(tr("Total Allocated"), price_format($total_allocated),
        ...
        label_row(tr("Left to Allocate"), $font1 . $left_to_allocate . $font2,
