...
page(tr("View Sales Dispatch"), true, false, "", $js);
...
display_heading(sprintf(tr("DISPATCH NOTE #%d"),$trans_id));
...
label_row(tr("TOTAL VALUE"), $display_total, "colspan=6 align=right",
	"nowrap align=right");
end_table(1);
