...
function print_annual_expense_breakdown()
{
	...
	$headers = array(tr('Account'), tr('Account Name'), $per01, $per02, $per03, $per04,
    ...
    else if ($dim == 1)
    {
    	$params =   array( 	0 => $comments,
                    	...
                    	2 => array('text' => tr('Dimension'),
                    		'from' => get_dimension_string($dimension), 'to' => ''),
                    	3 => array('text' => tr('Info'), 'from' => tr('Amounts in thousands'),
                    		'to' => ''));
    }
    else
    {
    	$params =   array( 	0 => $comments,
                    	1 => array('text' => tr("Year"),
                    		'from' => $year, 'to' => ''),
                    	2 => array('text' => tr('Info'), 'from' => tr('Amounts in thousands'),
                    		'to' => ''));
    }
