...
{
	$sql= "SELECT COUNT(*) FROM tax_group_items	WHERE tax_type_id=$selected_id";
...
$th = array(tr("Description"), tr("Default Rate (%)"),
	tr("Sales GL Account"), tr("Purchasing GL Account"), "", "");
table_header($th);
