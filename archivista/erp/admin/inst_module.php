...
page(tr("Install/Update Modules"));
...
$names = array(tr("Sales"), tr("Purchases"), tr("Items and Inventory"), tr("Manufacturing"), 
	tr("Dimensions"), tr("Banking and General Ledger"), tr("Setup"));
